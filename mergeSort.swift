...
func merge(leftPile: [Int], rightPile: [Int]) -> [Int] {
 ...
 // If control exits from the previous loop, left or right pile has contents merged into orderedPile, so append the rest of whatever is in the other array until everything is appended 
