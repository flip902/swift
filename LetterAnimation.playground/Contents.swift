...
var string = "Welcome to Haligrove"
let attributes: [NSAttributedStringKey: Any] = [
    NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1),
    NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): UIFont.boldSystemFont(ofSize: 32)]
...
attributedCharacters.enumerated().forEach({ (idx, char) in
    ...
    colorChar.addAttribute(NSAttributedStringKey.foregroundColor, value: randomColor(), range: NSMakeRange(0, 1))
