 ...
 */
let fam = ["Billy", "Sarah", "Jada", "Brayden", "Donna"]
let sortedCollection1 = fam.sorted(by: forwards)
 ...
 */
let sortedCollection2 = fam.sorted { (name1, name2) -> Bool in
    return name1 < name2
}
 ...
 */
let sortedCollection3 = fam.sorted { $0 < $1 }
