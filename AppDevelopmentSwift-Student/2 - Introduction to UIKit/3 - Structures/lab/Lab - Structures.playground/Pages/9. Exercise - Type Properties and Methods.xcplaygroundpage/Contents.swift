...
struct User {
    ...
    static func logIn(user: User) {
        let user = user
        print("\(user.userName) is now logged in, email: \(user.email), age: \(user.age)")
    }
    
}
var currentUser = User(userName: "Bob", email: "bob@gmail.com", age: 28)
 ...
 */
var me = User(userName: "Billy", email: "me@gmail.com", age: 35)
User.logIn(user: me)
