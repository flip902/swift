 ...
 */
var billy = User(name: "Billy", age: 35, height: 6.0, weight: 150, activityLevel: 6)
print("Hi my name is \(billy.name), I'm a fucking beast at \(billy.weight) lbs. I'm a \(billy.activityLevel)/10")
...
var myDistance = Distance(meters: 1600)
