...
var myRunningWorkout = RunningWorkout(distance: 1600, time: 100, elevation: 13)
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congratulations your goal has been reached!")
            }
        }
    }
    var goal: Int
...
var mySteps = Steps(steps: 99, goal: 100)
mySteps.takeStep()
